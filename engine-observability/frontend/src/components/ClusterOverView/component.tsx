...
export default function ClusterOverViewComponent(props: ClusterOverViewProps) {
  const { title, url, items, connected, handleFilterChange } = props;
              ...
              <Tooltip title={connected ? 'Connected' : 'Disconnected'}>
                <span
                  style={{
                    height: '16px',
                    width: '16px',
                    backgroundColor: connected ? '#04A96D' : '#FF0000',
                    borderRadius: '50%',
