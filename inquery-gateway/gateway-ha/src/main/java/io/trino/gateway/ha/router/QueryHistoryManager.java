...
public interface QueryHistoryManager
{
            ...
            implements Comparable<QueryDetail>
    {
        ...
        private String estimatedCpuTime;
        ...
        public String getEstimatedCpuTime()
        {
            return this.estimatedCpuTime;
        }

        public void setEstimatedCpuTime(String estimatedCpuTime)
        {
            this.estimatedCpuTime = estimatedCpuTime;
        }
        ...
        public boolean equals(Object o)
        {
            ...
            return captureTime == that.captureTime &&
                    ...
                    Objects.equals(estimatedCpuTime, that.estimatedCpuTime);
        }

        @Override
        public int hashCode()
        {
            return Objects.hash(queryId, queryText, user, source, backendUrl, estimatedCpuTime, captureTime);
        }
        ...
        public String toString()
        {
            return toStringHelper(this)
                    ...
                    .add("estimatedCpuTime", estimatedCpuTime)
