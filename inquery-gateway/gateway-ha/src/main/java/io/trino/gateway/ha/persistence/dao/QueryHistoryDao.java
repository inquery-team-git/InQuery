...
public interface QueryHistoryDao
{
    ...
    @SqlUpdate("""
            INSERT INTO query_history (query_id, query_text, backend_url, user_name, source, estimated_cpu_time, created)
            VALUES (:queryId, :queryText, :backendUrl, :userName, :source, :estimatedCpuTime, :created)
            """)
    void insertHistory(String queryId, String queryText, String backendUrl, String userName, String source, String estimatedCpuTime, long created);
